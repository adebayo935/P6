  ...
  .then(function(value) {
	...
	fetch(film1_url)
	  ...
	  .then(function(value) {
		...
		const image = document.getElementById("best_film_1_img")
		image.src = value.image_url;
		image.width = 250;
		image.height = 310;
		image.align = "center";
		
		document.getElementById("best_film_1_img").addEventListener("click",function(){
	...
	fetch(film2_url)
	  ...
	  .then(function(value) {
		...
		const image2 = document.getElementById("best_film_2_img")
		image2.src = value.image_url;
		image2.width = 250;
		image2.height = 310;
		image2.align = "center";
		
		document.getElementById("best_film_2_img").addEventListener("click",function(){
			document.getElementsByClassName
			("fondo_transparente")[0].style.display="block"
			document
			 .getElementById("title")
	...
	fetch(film3_url)
	  ...
	  .then(function(value) {
		...
		const image3 = document.getElementById("best_film_3_img")
		image3.src = value.image_url;
		image3.width = 250;
		image3.height = 310;
		image3.align = "center";
		
		document.getElementById("best_film_3_img").addEventListener("click",function(){
			document.getElementsByClassName
			("fondo_transparente")[0].style.display="block"
			document
			 .getElementById("title")
	...
	fetch(film4_url)
	  ...
	  .then(function(value) {
		...
		const image4 = document.getElementById("best_film_4_img")
		image4.src = value.image_url;
		image4.width = 250;
		image4.height = 310;
		image4.align = "center";
		
		document.getElementById("best_film_4_img").addEventListener("click",function(){
			document.getElementsByClassName
			("fondo_transparente")[0].style.display="block"
			document
			 .getElementById("title")
	  ...
	  .then(function(value) {
		...
		fetch(film5_url)
		  ...
		  .then(function(value) {
			...
			const image5 = document.getElementById("best_film_5_img")
			image5.src = value.image_url;
			image5.width = 250;
			image5.height = 310;
			image5.align = "center";
			
			document.getElementById("best_film_5_img").addEventListener("click",function(){
				document.getElementsByClassName
				("fondo_transparente")[0].style.display="block"
				document
				 .getElementById("title")
		...
		fetch(film6_url)
		  ...
		  .then(function(value) {
			...
			const image6 = document.getElementById("best_film_6_img")
			image6.src = value.image_url;
			image6.width = 250;
			image6.height = 310;
			image6.align = "center";
			
			document.getElementById("best_film_6_img").addEventListener("click",function(){
				document.getElementsByClassName
				("fondo_transparente")[0].style.display="block"
				document
				 .getElementById("title")
		...
		fetch(film7_url)
		  ...
		  .then(function(value) {
			...
			const image7 = document.getElementById("best_film_7_img")
			image7.src = value.image_url;
			image7.width = 250;
			image7.height = 310;
			image7.align = "center";
			
			document.getElementById("best_film_7_img").addEventListener("click",function(){
				document.getElementsByClassName
				("fondo_transparente")[0].style.display="block"
				document
				 .getElementById("title")
...
/* const next = document.querySelector('.next-best');
const prev = document.querySelector('.prev-best');
const slider = document.querySelector('.slider-best');
